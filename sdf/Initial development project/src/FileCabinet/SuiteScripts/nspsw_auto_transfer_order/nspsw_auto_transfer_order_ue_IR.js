    ...
    function(record, runtime, https, error, task, search) {
        ...
        function beforeSubmit(scriptContext) {
            ...
            try {
                ...
                log.debug("Default value:",scriptObj.getParameter({name: 'custscript_nspsw_default_value'}))
                            ...
                            if(SOStatus != "G" && SOStatus != "F"){
                                ...
                                if(!isClosed && quantity>=fullfilledQuantity){
                                    ...
                                    var lookUp = search.lookupFields({
                                        ...
                                        id: scriptObj.getParameter({name: 'custscript_nspsw_default_value'}),
                                        columns: ['custrecord_conf_ato_mapping_default']
                                    });
                                    log.debug('lookUp.custrecord_conf_ato_mapping_default',lookUp.custrecord_conf_ato_mapping_default);
                                    ...
                                    if(!featureInEffect){
                                        soRecord.setSublistValue({
                                            ...
                                            line: lineNumber,
                                            value: lookUp.custrecord_conf_ato_mapping_default
                                        });
                                    }
                                    else{
                                        soRecord.setSublistValue({
