...
define( //using require instead for better module loading especially for the have dependencies.
    function (require)
    {
        ...
        const PARAM_DEF = {
            promptid: { id: 'wfll_category_prompt_id', optional: true },
            logactivity: { id: 'wfll_logallactivity', optional: true },
            dataset1: { id: 'wfll_category_dset1', optional: true },
            datasetcond1: { id: 'wfll_category_dset1_condition', optional: true },
            dataset2: { id: 'wfll_category_dset2', optional: true },
            datasetcond2: { id: 'wfll_category_dset2_condition', optional: true },
            dataset3: { id: 'wfll_category_dset3', optional: true },
            datasetcond3: { id: 'wfll_category_dset3_condition', optional: true },
            files: { id: 'wfll_category_filecabinet', optional: true },
            bodyfields: { id: 'wfll_category_bodyfields', optional: true },
            attachments: { id: 'wfll_category_attachments', optional: true },
        };
