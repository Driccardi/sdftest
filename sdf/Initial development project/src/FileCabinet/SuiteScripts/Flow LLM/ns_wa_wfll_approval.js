...
define( //using require instead for better module loading especially for the have dependencies.
    function (require)
    {
        ...
        const PARAM_DEF = {
            promptid: { id: 'wfll_approval_promptid', optional: true },
            logactivity: { id: 'wfll_logallactivity', optional: true },
            dataset1: { id: 'wfll_approval_dset1', optional: true },
            datasetcond1: { id: 'wfll_approval_dset1_condition', optional: true },
            dataset2: { id: 'wfll_approval_dset2', optional: true },
            datasetcond2: { id: 'wfll_approval_dset2_condition', optional: true },
            dataset3: { id: 'wfll_approval_dset3', optional: true },
            datasetcond3: { id: 'wfll_approval_dset3_condition', optional: true },
            files: { id: 'wfll_approval_filecabinet', optional: true },
            bodyfields: { id: 'wfll_approval_bodyfields', optional: true },
            attachments: { id: 'wfll_approval_attachments', optional: true },
        };
        ...
        EntryPoint.onAction = function (context)
        {
            ...
            try
            {
                ...
                Helper.buildSavedSearch(params,docs); // Create dataset from Workbook/SQL/Saved Search
