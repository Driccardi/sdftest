...
define([
    ...
    function (runtime, search, record, task, file, error) {
        ...
        function getInputData() {
            ...
            var strSavedSearchParamId = 'custscript_ns_md_search_id';
            var strDeleteParamId = 'custscript_ns_md_mr_delete';
        ...
        function summarize(summary) {
            ...
            var strSavedSearchParamId = 'custscript_ns_md_search_id';
            var strMRInternalIdParamId = 'custscript_ns_md_mr_internal_id'
            var strDeleteParamId = 'custscript_ns_md_mr_delete';
