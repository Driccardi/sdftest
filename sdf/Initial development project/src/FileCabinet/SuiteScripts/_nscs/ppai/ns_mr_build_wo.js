 ...
 */ (log, search, runtime, record) => {
    ...
    const getInputData = (context) => {
        ...
        const intForBuildWOSearch = objScript.getParameter({ name: "custscript_ns_for_build_wo_search" });
        const intProdPlusRec = objScript.getParameter({ name: "custscript_ns_prod_plus_rec" });
