...
**Type**: Type 5 - Out of Scope Confirmation → **RESOLVED - IN SCOPE**
**Description**: ~~CKB doesn't mention wholesale/B2B customers~~ **NEW INFO (2026-01-30)**: Wholesale business confirmed - sports teams purchasing custom-designed frames.
**Impact**: Confirmed need for wholesale customer management, custom quote-to-order process, design team workflow integration.
**Questions**:
- ~~Is there any wholesale or B2B business?~~ **CONFIRMED: YES**
- ~~If yes, what % of revenue?~~ **OPEN**
- What are the differences in process (terms, pricing, shipping)? **PARTIALLY KNOWN** - see new Quote-to-Order process doc
**Required From**: CEO, Sales
**Priority**: High (major scope addition)
**Status**: Partially Resolved - New process documented in `quote-to-order-wholesale.md` with open questions
...
### GAP-OTC-007: Quote-to-Order Design Workflow
**Type**: Type 2 - Unclear Process
**Description**: NEW (2026-01-30) - Custom wholesale quote process for sports teams requires design team involvement and custom sourcing.
**Impact**: Requires Estimate customizations, design workflow, integration with Sourcing Tracker, and new testing scenarios.
**Questions**:
...
- Should Sourcing Tracker have a field to link to Estimate records?
- How are custom specifications communicated to vendors?
- What is the customer approval workflow for quotes?
- Are custom frames drop-shipped or received into inventory?
- What are the payment terms for custom wholesale orders?
- Should design specifications be a separate custom record or just fields?
- Are there external systems for design management?
**Required From**: Sales Team (Wholesale), Design/Product Team, Purchasing
**Priority**: High (new scope, requires configuration and testing plan updates)
...
- Type 2 (Unclear Process): 17 (+1 new)
- Type 3 (System Detail Missing): 5
- Type 4 (Decision Pending): 2
- Type 5 (Out of Scope Confirmation): 2 (-1, resolved to Type 2)

**By Functional Area**:
- Record-to-Report: 4
- Order-to-Cash: 7 (+1 new)
- Procure-to-Pay: 4
- Plan-to-Inventory: 5
- Marketing/CRM: 2
- Customer Service: 2
...
**Week 1**:
- ~~GAP-OTC-005: Wholesale confirmation~~ **CONFIRMED** - now GAP-OTC-007 for process details
- GAP-OTC-007: Quote-to-Order design workflow details (new scope addition)
